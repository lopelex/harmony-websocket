...
class Harmony extends EventEmitter {
    ...
    constructor() {
        ...
        this._client = null;
        this._interval = null;
        this._connectTimeout = DEFAULT_TIMEOUT;
        this._sendTimeout = DEFAULT_TIMEOUT;
    }
    ...
    connect(ip) {
        ...
        return this._getRemoteId(ip, connect_timeout)
            .then(data => {
    ...
    _heartbeat() {
        ...
        // timeout = 60s
        this._interval = setInterval(() => this._client.send(''), 50000);
    }
    ...
    /**
     * @deprecated use sendCommandWithDelay(action, delay)
     */
    sendCommandsWithDelay(action, delay) {

        return sendCommandWithDelay(action, delay);
    }

    sendCommandWithDelay(action, delay) {
